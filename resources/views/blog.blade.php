   ...
   <main class="container">
      ...
      <section class="cards-blog latest-blog">
        <div class="card-blog-content">
          ...
          <h4>
            <a href="blog/single">Benefits of getting covid 19 vaccination</a>
          </h4>
        </div>
        ...
        <div class="card-blog-content">
          ...
          <h4 style="font-weight: bolder">
            <a href="blog/single">WRC Safari Rally Back To Kenya After 19 Years</a>
          </h4>
        </div>
        ...
        <div class="card-blog-content">
          ...
          <h4 style="font-weight: bolder">
            <a href="blog/single">12 Health Benefits Of Pomegranate Fruit</a>
          </h4>
        </div>
        ...
        <div class="card-blog-content">
          ...
          <h4 style="font-weight: bolder">
            <a href="blog/single">Nairobi, The Only City In The World With A National Park</a>
          </h4>
        </div>
